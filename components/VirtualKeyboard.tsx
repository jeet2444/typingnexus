...
// --- REMINGTON GAIL / CBI (NEW) ---
const REMINGTON_DISPLAY_MAP: Record<string, { normal: string, shift?: string }> = {
  'q': { normal: 'ु', shift: 'फ' },
  'w': { normal: 'ू', shift: 'ॅ' },
  'e': { normal: 'म', shift: 'म्' },
  'r': { normal: 'त', shift: 'त्' },
...
const VirtualKeyboard: React.FC<VirtualKeyboardProps> = ({ activeChar, language = 'english', layout = 'qwerty', pressedKey }) => {
  ...
  const getKeyClass = (key: string) => {
    ...
    const textStyle = "text-[10px] sm:text-sm font-bold font-mono";
